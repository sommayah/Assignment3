...
public class Utilies
{
    ...
    //sommayah soliman: correct league numbers
    ...
    public static String getMatchDay(int match_day,int league_num, Context context)
    {
        ...
        {
            return context.getString(R.string.match_day_text2) + String.valueOf(match_day);
        }
    }
    ...
    //sommayah soliman: check in no matches because there is no internet connection
